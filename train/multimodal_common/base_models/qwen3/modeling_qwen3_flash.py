...
class Qwen3RotaryEmbedding(nn.Module):
    ...
    def _default_rope_init(config, device=None):
        ...
        dim = getattr(config, 'head_dim', None) or int(config.hidden_size / config.num_attention_heads)
    ...
    def _prepare_4d_causal_attention_mask_with_cache_position(
        ...
        if attention_mask is not None and attention_mask.dim() == 4:
            ...
            if config.sliding_window is not None:
                ...
                if (SlidingWindowCache is None or not isinstance(past_key_values, SlidingWindowCache)) or sequence_length > target_length:
